...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  const [hideExtra, setHideExtra] = useState<Boolean>(false);
  ...
  useEffect(() => {
    ...
    if (router.pathname === "/login" || router.pathname === "/signup" || router.pathname === "/forgot-password" || router.pathname === "/reset-password" || router.pathname === "/verify-email" || router.pathname === "/createProject" ) {
      setHideExtra(true);
      setLoading(false);
    }
    else {
